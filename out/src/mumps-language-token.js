...
const mumps_label_lookup_1 = require("./mumps-label-lookup");
    ...
    get isLabelReference() {
        if (this._isLabelReference === undefined) {
            ...
            if (match) {
                ...
                this.referredToLabel = mumps_label_lookup_1.lookupLabelReference(this);
            }
        }
    ...
    get definition() {
        if (this._definition === undefined) {
            ...
            if (matches) {
                ...
                this._definition = mumps_label_lookup_1.createDefinitionForLabelReference(this.referredToLabel);
            }
